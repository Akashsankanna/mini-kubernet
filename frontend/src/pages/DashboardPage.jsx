    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card">
          <h3 className="text-lg font-bold text-gray-900 mb-6">Recent Deployments</h3>
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">Deployment #{item}</h4>
                  <p className="text-sm text-gray-600">Kubernetes Service Deployment</p>
                </div>
      ...
      {/* Services Section */}
      <div className="card">
        <h3 className="text-lg font-bold text-gray-900 mb-6">Services Overview</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {['API Gateway', 'Auth Service', 'Build Service'].map((service, index) => (
